...
import { Sparkles, Lock, Mail, Loader2, UserPlus } from "lucide-react";
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-card/40 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in-95 duration-500 delay-200">
                    ...
                    <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center gap-4">
                        <Link href="/login" className="text-[10px] text-gray-500 hover:text-white transition-colors uppercase tracking-[0.2em]">
